  ...
  <div>
    ...
    <?php elseif($config == true): ?>
      ...
      <?php if($state == '0'): ?>
        ...
        <p>Ceate backup of all files in direcotroy <code><?php echo SITE_BASE_DIR; ?></code>:</p>
      ...
      <?php elseif($state == '1'): ?>
        ...
        <?php if($bkp_data == true): ?>
          ...
          <?php echo SITE_HAS_DB == true ? '<p>Go on with backup of database <code>'. DB_NAME .'</code>:</p>' : '<p>Compress data in a ZIP archive and prepare for download:</p>'; ?>
